...
own object model, and two more for what happens after a run finishes.
...
| `/agentic-bioflow:finish` | outside Seqera's model — assembles methods, citations and provenance into a package |
